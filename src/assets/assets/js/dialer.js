...
function postInit() {
    ...
    oConfigCall = {
        ...
        events_lievents_listenerstener: { events: '*', listener: onSipEventSession },
        sip_caps: [
                        { name: '+g.oma.sip-im' },
...
function saveCredentials() {
    ...
    if (window.localStorage) {
        ...
        // window.localStorage.setItem('org.doubango.expert.video_size', null);
        ...
        // window.localStorage.setItem('org.doubango.expert.bandwidth', null);
...
function sipRegister() {
    ...
    try {
        ...
        oSipStack = new SIPml.Stack({
            ...
            websocket_proxy_url: (window.localStorage ? window.localStorage.getItem('org.doubango.expert.websocket_server_url') : 'wss://onlinevoipcalls.com:8089/ws'),
...
function uiCallTerminated(s_description) {
    ...
    var datastring = {
        call_disconnect : dateTime,
        call_id : sessionStorage.getItem('callid'),
        disconnect_time : dateTime
    };
    debugger
    // var ACCESS_TOKEN = sessionStorage.getItem('ACCESS_TOKEN');
    // var headers = { 'X-AUTH-TOKEN' : ACCESS_TOKEN}  
    // $.ajax({
    //     url: "https://sisgain.com:3005/user/end/call",
    //     type: 'POST',
    //     data: datastring,
    //     headers: headers,
    //     dataType: "json",
        ...
        case 'connecting': case 'connected': 
            {
                ...
                if (e.session == oSipSessionRegister) {
                    ...
                    if (bConnected) {
                        ...
                        var headers = { 'X-AUTH-TOKEN' : ACCESS_TOKEN}  ;
                        // $.ajax({
                        //     url: "https://sisgain.com:3005/user/receive/call",
                        //     type: 'POST',
                        //     data: datastring,
                        //     dataType: "json",
                        //     headers:headers,
        ...
        case 'm_early_media':
            {
                if (e.session == oSipSessionCall) {
                    ...
                    var today = new Date();
                        ...
                        var datastring = {
                             extension : "2014",
                             phone_no : window.localStorage.getItem('org.doubango.call.phone_number')
                            // from_no : window.localStorage.getItem('org.doubango.call.phone_number'),
                            // to_no : window.localStorage.getItem('org.doubango.call.phone_number'),
                            // calling_by : data.users_id,
                    ...
                    //    var headers = { 'X-AUTH-TOKEN' : ACCESS_TOKEN}  ;
                    //     $.ajax({
                    //         url: "https://sisgain.com:3005/asterisk/test",
                    //         type: 'POST',
                    //         data: datastring,
                    //         dataType: "json",
                    //         headers: headers,
...
//     $('#starttimer').html((hours ? (hours > 9 ? hours : "0" + hours) : "00") + ":" + (minutes ? (minutes > 9 ? minutes : "0" + minutes) : "00") + ":" + (seconds > 9 ? seconds : "0" + seconds));
