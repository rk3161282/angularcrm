...
@Component({
  selector: 'app-callscreen',
  templateUrl: './callscreen.component.html',
  styleUrls: ['./callscreen.component.css']
...
export class CallscreenComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.getvideocalllist('project');
    this.projectname = "project";
    this.virtualUrl = environment.siteURL+"virtualUrl/"+this.projectname;
  ...
  getvideocalllist(project){
    ...
    this.authService.getvideocalllist(project)
    .subscribe((data: any[])=> {
      console.log(data);
        this.call_list = data;
     debugger
  ...
  smssendvideolink(){
    ...
    this.SpinnerService.show();
    this.authService.smssendvideolink(datastring)
    .subscribe((data: any[])=> {
      console.log(data);
     debugger
        this.SpinnerService.hide();
   ...
   emailsendvideolink(){
    ...
    this.SpinnerService.show();
    this.authService.emailsendvideolink(datastring)
    .subscribe((data: any[])=> {
      console.log(data);
     debugger
        this.SpinnerService.hide();
  ...
  //  this.restApi.sendVirtualUrl(datastring).subscribe((data:any) => {
  ...
  //       // this.showToast('success','Virtual Url',data.status_message);
  //     }
  //   })
